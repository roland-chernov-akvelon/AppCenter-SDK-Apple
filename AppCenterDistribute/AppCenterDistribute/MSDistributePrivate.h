 ...
 */
static NSString *const kMSDefaultInstallUrl = @"http://install.appcenter-int.trafficmanager.net";
...
/**
 * The storage key for latest downloaded release The storage key for latest downloaded release ID.ID.
 */
